...
export default function PlaceCard({ place }: { place: Place }) {
  ...
  return (
    <article onClick={() => handleLocation(place?.id)}
    ...
    >
        ...
        <div className="relative z-20 flex h-full flex-col justify-end p-6">
          ...
          <p className="mt-1 text-sm text-white/80">📍 {place.location}</p>
          ...
          <div className="mt-5 flex items-center justify-between">
            ...
            <span className="text-xs text-white/60">Lombok, NTB</span>
          </div>
        </div>
